...
Load_Performance <- lm(ErrorRate_Trial1 ~ Load_C, data = df_Load)
...
Load_Performance_Incong <- lm(ErrorRate_Trial1 ~ Load_C, data = df_Load_Incongruent)
...
Load_Performance_Cong <- lm(ErrorRate_Trial1 ~ Load_C, data = df_Load_Congruent)
