...
warning("In this part, I do not calculate the error and error rates for trial 2, trial 3, trial 4, and trial divided. The number of bounces counting are listed in a notebook")
...
df_Final <- df %>% 
  select(Study_Name, response_id, participant, TIME_total, 
         ...
         Error_Trial1, Error_TrialCritic,
         ErrorRate_Trial1, ErrorRate_TrialCritic,
